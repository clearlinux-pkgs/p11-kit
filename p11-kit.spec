...
Source0  : https://github.com/p11-glue/p11-kit/releases/download/0.25.4/p11-kit-0.25.4.tar.xz
...
%prep
%setup -q -n p11-kit-0.25.4
cd %{_builddir}/p11-kit-0.25.4
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a p11-kit-0.25.4 build32
popd
pushd ..
cp -a p11-kit-0.25.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719957218
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libp11-kit.so.0.4.0
